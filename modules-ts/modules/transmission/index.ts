...
async function transmission_addTorrent(host: string, login: string | undefined, password: string | undefined, magnet: string, downloadDir?: string, paused?: boolean): Promise<{ok: boolean, error?: string}> {
